...
/* PREGUNTAR SI EL TIPO DE DOCUMENTO ES CON NUMEROS O CON STRING */
const DOC_TYPES = [
  { value: "1", label: "DNI" },
  { value: "2", label: "RUC" },
...
export default function Predial() {
  ...
  function handleBuscar(e) {
    ...
    // Solo es el frontend, así que hacemos un mocks
    const mock = [
      {
        id: 1,
    ...
    >
      ...
      <header className="relative bg-white shadow px-4 py-6">
        ...
        <div className="flex flex-col items-center">
          ...
          >
            Busque por documento o código de contribuyente
          </motion.p>
        </div>
      </header>
